<template>
  ...
  <q-page padding>
  	...
  	<!-- <food> receive from components/Food1.vue-->
  	  <food
  	  	v-for="food in foods"
  	  	:food="food"
  	  	:key="food.id"></food>
	<!-- :food="food" used to export the food then pass to the Food1.vue-->
  	</div>
  </q-page>
</template>
...
<script>
	export default {
		data() {
			return {
				foods: [
					...
					{
						id:4,
						imageUrl: 'https://i.imgur.com/3dml3Bt.jpg',
						name: 'Pasta',
		...
		components:{
			'food':require('components/Food1.vue').default
		}
	}
</script>
